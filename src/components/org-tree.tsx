...
export function OrgTree({
  ...
  if (nodes.length === 0) {
    return <p className="text-sm text-stone-400 text-center py-6">部署がまだ登録されていません</p>;
  }
  return (
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      >
        ...
        {ids.length === 0 && <p className="text-[10px] text-stone-300 mt-1">担当未設定</p>}
      </div>
        ...
        <>
          ...
          <div className="relative flex gap-4">
            ...
            {node.children.length > 1 && (
              <span className="absolute top-0 left-0 right-0 mx-auto h-px bg-stone-300"
